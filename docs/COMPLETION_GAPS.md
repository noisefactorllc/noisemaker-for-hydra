...
Date: 2026-09-24. Reviewed SHA: [`2691007f48acc5342c6a10478373094fff6fd697`](https://github.com/noisefactorllc/noisemaker-for-hydra/commit/2691007f48acc5342c6a10478373094fff6fd697).
...
Experimental browser editor for mixed Hydra and Noisemaker programs. The README explicitly limits this project to a technology demonstration. [Contract](https://github.com/noisefactorllc/noisemaker-for-hydra/blob/2691007f48acc5342c6a10478373094fff6fd697/README.md).

The editor loads `public/_engine/hydra-synth.js`. This pass did not resolve every embedded dependency to an immutable authority revision.
...
No GitHub release was returned. Registry and served-site qualification remain unverified.
...
|---|---|---|---|---|
| CLAIM-001 | [Historical source](https://github.com/noisefactorllc/noisemaker-for-hydra/blob/2691007f48acc5342c6a10478373094fff6fd697/README.md) | Editor evaluation, AST mutation, lifecycle, and browser compilation of default and encoded sketches. | partial | 36 Node tests passed. Browser scripts and rendered output were not exercised. |
| CLAIM-002 | [README](https://github.com/noisefactorllc/noisemaker-for-hydra/blob/2691007f48acc5342c6a10478373094fff6fd697/README.md) | Human usability: installation, output, errors, and recovery | unverified | Complete installed workflows were not observed. GAP-002. |
| CLAIM-003 | [Ecosystem reference](https://hydra.ojack.xyz/docs/docs/learning/getting-started/) | Ecosystem fit and version support | partial | Source entry points were examined. Installed integration and version qualification remain open. |
| CLAIM-004 | [README](https://github.com/noisefactorllc/noisemaker-for-hydra/blob/2691007f48acc5342c6a10478373094fff6fd697/README.md) | Release readiness | unverified | Metadata and CI do not replace installation of the actual artifact. GAP-003. |
| CLAIM-005 | [Exact-source Actions](https://github.com/noisefactorllc/noisemaker-for-hydra/actions?query=head_sha%3A2691007f48acc5342c6a10478373094fff6fd697) | Workflow status only | unverified | No Actions runs were returned at this source SHA. |

## 3. Methods and evidence

Environment: macOS 26.5, Darwin arm64.
[Source SHA-256 records](/Users/alex/.codex/automations/noisemaker-port-completion-audit/evidence-20260924-remaining-gap-documents/noisemaker-for-hydra-source-hashes.json) bind these checks to the reviewed revision.
[Raw command evidence](/Users/alex/.codex/automations/noisemaker-port-completion-audit/evidence-20260924-remaining-gap-documents/hydra-tests.json). [Remote evidence](/Users/alex/.codex/automations/noisemaker-port-completion-audit/evidence-20260924-remaining-gap-documents/noisemaker-for-hydra-remote.json).
...
36 Node tests passed. Browser scripts and rendered output were not exercised. Final exit code: 0.
No image denominator or tolerance follows from a unit-test or generated-file result.
Official reference: [Hydra rolling documentation, accessed 2026-09-24](https://hydra.ojack.xyz/docs/docs/learning/getting-started/).
...
| First useful output | Selected checks only | Run the README noise example, modify its scale, evaluate by keyboard, restore a saved URL, and recover from invalid DSL. |
...
| Distribution | Metadata inspection | Build the browser distribution in an isolated copy. Serve it without source folders. Check engine loading, license files, and URL restoration. |
...
- Affected scope: README.md, src/, test/, scripts/test.mjs, public/_engine/
- Expected behavior: Reproducible evidence binds each supported claim to the port and authority revisions.
- Observed behavior: Hydra normally exposes JavaScript live coding. This fork documents Polymorphic DSL. Compatibility with existing Hydra sketches is not established.
- Evidence: [Historical source](https://github.com/noisefactorllc/noisemaker-for-hydra/blob/2691007f48acc5342c6a10478373094fff6fd697/README.md) and section 3.
- Next action: Run browser cases and compare rendered frames across WebGL2 and WebGPU. Preserve compile failures and unsupported backend cases.
...
- Evidence: [README](https://github.com/noisefactorllc/noisemaker-for-hydra/blob/2691007f48acc5342c6a10478373094fff6fd697/README.md), [official reference](https://hydra.ojack.xyz/docs/docs/learning/getting-started/), and section 3.
- Next action: Run the README noise example, modify its scale, evaluate by keyboard, restore a saved URL, and recover from invalid DSL.
...
- Evidence: [Distribution instructions](https://github.com/noisefactorllc/noisemaker-for-hydra/blob/2691007f48acc5342c6a10478373094fff6fd697/README.md), section 1, and exact-source CI in section 2.
- Next action: Build the browser distribution in an isolated copy. Serve it without source folders. Check engine loading, license files, and URL restoration.
...
|---|---|---|---|---|
| 2026-09-24 | `2691007f48acc5342c6a10478373094fff6fd697` | Created six-section register and README link. No closures. | 36 Node tests passed. Browser scripts and rendered output were not exercised. | Full audit, installed workflows, current rendered parity, platforms, and releases remain unqualified. |
